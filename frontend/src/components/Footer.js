        ...
        <Row>
          ...
          <ul className='list-unstyled'>
            ...
            <LinkContainer to="collections">
                <li><button className='footerButtons'>Collections</button></li>
             </LinkContainer>
          ...
          <Col className='text-center py-3 text-info'>
            <ul className='list-unstyled'>
              ...
              <li>
                  <a href="https://www.pinterest.com/blackcatmacrame/?invite_code=96f1625f44a14a52a93506da06236db1&sender=340162715513308657"><i className="fa-brands fa-pinterest footer-icons"></i>pinterest</a>
              </li>
            </ul>
          </Col>
